      ...
      <section className="privacy-section">
        <div className="auto-container">
          ...
          <div className="privacy-content">
            ...
            <div className="date">Updated January 6, 2020</div>
            <p>
          ...
          <div className="privacy-content">
            ...
            <ul className="privacy-list">
              ...
              <li>
                Voluntarily consent to the collection, use and disclosure of
                such personal information as specified in this Privacy Policy.{" "}
              </li>
              <li>
                The legal bases for our processing of personal information are
                primarily that the processing is necessary for providing the
                Services and that the processing is carried out in our
                legitimate interests, which are further explained below.
              </li>
              <li>
                Without limiting the foregoing, we may on occasion ask you to
                consent when we collect.
              </li>
            </ul>
          </div>
          {/* Privacy Content */}
